...
Коммиты за вчера по всем `/Users/andrey_akatov/github/*/` репо. Сопоставить с DayPlan.
...
**Проверка обновлений:** `cd /Users/andrey_akatov/github/FMT-exocortex-template && bash update.sh --check 2>&1`. Если доступно обновление → добавить в «Требует внимания»: «Доступно обновление IWE → `/iwe-update`».
