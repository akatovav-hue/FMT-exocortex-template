...
```bash
cd /Users/andrey_akatov/github/FMT-exocortex-template && bash update.sh --check 2>&1
```
...
```bash
cd /Users/andrey_akatov/github/FMT-exocortex-template && bash update.sh --yes 2>&1
```
