...
1. **WP Gate:** ЛЮБОЕ задание → протокол Открытия → ДО начала работы.
   **Ритуал согласования (горячий, не lazy):** при создании нового РП (нет в плане недели) Claude обязан:
   ...
   - Шаг 2. **Дождаться согласования.** Без явного «да»/«делаем»/«открывай» от пользователя — НЕ регистрировать РП в 4 местах (REGISTRY/WeekPlan/context/Linear). Это исключение из Правила 6 (Автономность).
...
<<<<<<< /var/folders/kn/j2bgxzrx2yl9cgl6sxc3nw4h0000gn/T/tmp.Ys3TaQKQOa/claude-merge.md
...
=======
>>>>>>> /var/folders/kn/j2bgxzrx2yl9cgl6sxc3nw4h0000gn/T/tmp.Ys3TaQKQOa/files/CLAUDE.md
...
<<<<<<< /var/folders/kn/j2bgxzrx2yl9cgl6sxc3nw4h0000gn/T/tmp.SFjhECEwvP/claude-merge.md
**Для автора шаблона:** прямое редактирование L1 файлов РАЗРЕШЕНО.
- **Flow:** `scripts/template-sync/` (авторский инструмент в корневом IWE) синхронизирует корень → FMT.
  1. L1 файл УЖЕ в `sync-manifest.yaml` → правим в корне → `template-sync.sh --apply` → commit FMT
  2. L1 файл ЕЩЁ НЕТ в manifest → правим напрямую в FMT (пока правило не добавлено)
  3. Новый файл в FMT отсутствует в корне → `--bootstrap <path>` (разовое, FMT→корень)
- **Правило безопасности:** перед `--apply` — commit всех FMT-изменений (скрипт aborts при uncommitted)
- **Детали архитектуры:** ADR-003 Template-sync контракт (docs/adr/ADR-003-template-sync.md)
=======
...
>>>>>>> /var/folders/kn/j2bgxzrx2yl9cgl6sxc3nw4h0000gn/T/tmp.SFjhECEwvP/files/CLAUDE.md
...
<<<<<<< /var/folders/kn/j2bgxzrx2yl9cgl6sxc3nw4h0000gn/T/tmp.lGetIseaRL/claude-merge.md
...
>>>>>>> /var/folders/kn/j2bgxzrx2yl9cgl6sxc3nw4h0000gn/T/tmp.lGetIseaRL/files/CLAUDE.md
