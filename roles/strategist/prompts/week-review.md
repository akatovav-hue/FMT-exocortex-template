...
```markdown
**Пост итогов W{N-1}:** [название](https://github.com/your-username/DS-Knowledge-Index/blob/main/docs/{YYYY}/{YYYY-MM-DD}-week-review-w{N-1}.md) — status: ready → авто-публикация Пн 07:14
```
