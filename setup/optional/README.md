...
sed "s|/Users/andrey_akatov/IWE|$HOME/IWE|g" setup/optional/pomodoro-alert.plist \
...
| `pomodoro-alert.plist` | launchd agent template (replace `/Users/andrey_akatov/IWE`) |
